            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="https://mail.google.com/mail/?view=cm&fs=1&to=queenofdelhiofficial@gmail.com"
  target="_blank"
  rel="noopener noreferrer"
   className="text-zinc-400 hover:text-white transition-colors">
                  <p className="text-zinc-400 mt-1">
                  queenofdelhiofficial@gmail.com
                  </p>
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 mt-1">C-35 South Extension Part-2, New Delhi-110049</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="flex space-x-4 mt-2">
                    <a href="https://www.instagram.com/queenofdelhi.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-zinc-400 hover:text-white transition-colors">
                      Instagram
                    </a>
                    <a href="https://www.youtube.com/@queenofdelhiofficial" className="text-zinc-400 hover:text-white transition-colors">
                      Youtube
                    </a>
