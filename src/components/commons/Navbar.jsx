...
import Logo from '../../assets/images/QOD.png' // Adjust the import based on your logo path
            ...
            <div className="ml-10 flex items-baseline space-x-6">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-[yellow] hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200"
                >
                  {link}
                </a>
              ))}
